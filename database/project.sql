...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2024 at 07:45 PM
...
(2, 'test1', '2024-01-15', '200.00', '2024-01-15 12:33:05', 'ใช้งานแล้ว'),
(7, 'test2', '2024-01-31', '300.00', '2024-01-17 16:44:50', 'ใช้งานแล้ว'),
(8, 'test3', '2024-01-30', '200.00', '2024-01-17 17:12:29', 'ใช้งานแล้ว'),
(13, 'test4', '2024-02-29', '200.00', '2024-02-05 14:33:50', 'ใช้งานแล้ว');
...
CREATE TABLE `tbl_member` (
  ...
  `cheack_fb` varchar(50) NOT NULL COMMENT 'ผู้ใช้Facebook',
...
INSERT INTO `tbl_member` (`member_id`, `m_user`, `m_pass`, `m_level`, `m_name`, `m_email`, `m_tel`, `m_address`, `cheack_fb`, `m_date_save`) VALUES
(1, 'admin', '$2y$10$jiFQORtz61Re5hN6dP9hj.IVHRKNtfqPRDWz8b2xQO0tVM/kiS0Te', 'super_admin', 'admin', 'admin@gmail.com', '0999999999', 'songkhla', 'เจ้าของระบบ', '2022-02-04 16:26:57'),
(2, 'member', '$2y$10$/xjog/uyd2puiJpRYEgIPe3KGi2EsmSdhGC/EvrPqEVI/gzB5oq1q', 'member', 'chanutorn', 'chanutorn@gmail.com', '0888888888', 'songkhla', 'ผู้ใช้งานทั่วไป', '2021-06-01 19:05:54'),
(3, 'admin1', '880c64425becf21d986c330708b28364e3179df376c774cf907da99684075707', 'admin', 'admin1', 'admin1@gmail.com', '0999999999', 'hatyai', 'ผู้ใช้งานทั่วไป', '2021-06-01 19:04:28'),
(4, 'admin2', '880c64425becf21d986c330708b28364e3179df376c774cf907da99684075707', 'admin', 'admin2', 'admin2@gmail.com', '0999999999', 'hatyai', 'ผู้ใช้งานทั่วไป', '2021-06-01 19:09:04'),
(5, 'admin3', '$2y$10$jiFQORtz61Re5hN6dP9hj.IVHRKNtfqPRDWz8b2xQO0tVM/kiS0Te', 'admin', 'admin3', 'admin3@gmail.com', '0878898456', 'songkhla', 'ผู้ใช้งานทั่วไป', '2022-03-04 03:00:05'),
(6, 'admin4', '$2y$10$jiFQORtz61Re5hN6dP9hj.IVHRKNtfqPRDWz8b2xQO0tVM/kiS0Te', 'member', 'admin4', 'admin4@gmail.com', '0657487454', 'hatyai', 'ผู้ใช้งานทั่วไป', '2022-03-04 03:00:47'),
(7, 'admin5', '$2y$10$jiFQORtz61Re5hN6dP9hj.IVHRKNtfqPRDWz8b2xQO0tVM/kiS0Te', 'member', 'admin5', 'admin5@gmail.com', '', 'hatyai', 'ผู้ใช้งานทั่วไป', '2022-03-09 16:54:30'),
(9, 'member1', '$2y$10$sEQ2OUpzfhQEIFvayTCxpuoR67.YjAC5AQO.XoHv4A7RCdBfGw0Iq', 'member', 'member1', 'member1@gmail.com', '', 'หาดใหญ่\r\n', 'ผู้ใช้งานทั่วไป', '2021-06-01 19:06:39'),
(10, 'member2', '880c64425becf21d986c330708b28364e3179df376c774cf907da99684075707', 'member', 'member2', 'member2@gmail.com', '0123456789', 'songkhla', 'ผู้ใช้งานทั่วไป', '2022-02-13 17:37:50'),
(11, 'member3', '880c64425becf21d986c330708b28364e3179df376c774cf907da99684075707', 'member', 'member3', 'member3@gmail.com', '0123456789', 'songkhla', 'ผู้ใช้งานทั่วไป', '2022-02-14 05:32:51'),
(12, 'tang', '$2y$10$jiFQORtz61Re5hN6dP9hj.IVHRKNtfqPRDWz8b2xQO0tVM/kiS0Te', 'member', 'ชาณุธร ไทยนุกูล', 'chanuorn@gmail.com', '0123456789', 'songkhla', 'ผู้ใช้งานทั่วไป', '2022-02-26 20:13:10'),
(40, 'member5', '7f6b85be3e9eb1725a7c49014c8facde4b465c7be2126cd02c7d45c56712f05e', 'member', 'member5', 'member5@gmail.com', '0999999999', '135453', '', '2024-01-14 15:39:55'),
(43, 'CT', '', 'member', 'Chanutorn Thainukul', 'chanutorneiei@gmail.com', '', '', 'ผู้ใช้Facebook', '2024-03-01 13:19:34');
...
CREATE TABLE `tbl_order` (
  ...
  `status` enum('รอตรวจสอบ','กำลังเตรียมสินค้า','รอเลขพัสดุ','ส่งสินค้าแล้ว','ยกเลิกออเดอร์') NOT NULL COMMENT 'สถานะ',
...
INSERT INTO `tbl_order` (`o_id`, `o_code`, `m_id`, `p_id`, `qty`, `total`, `date`, `status`, `tracking`, `slip`) VALUES
(1, '22401141521', 2, 12, 1, 2140, '2024-01-14 08:21:14', 'รอตรวจสอบ', '', ''),
...
(4, '22401172347', 2, 12, 1, 1940, '2024-01-17 16:47:43', 'รอเลขพัสดุ', '', ''),
(5, '22401172347', 2, 12, 1, 1940, '2024-01-17 16:47:55', 'รอเลขพัสดุ', '', ''),
...
(10, '9240118091611', 9, 12, 1, 2040, '2024-01-18 02:16:11', 'รอตรวจสอบ', '', ''),
...
(46, '43240305011013', 43, 14, 1, 2080, '2024-03-04 18:10:13', 'รอตรวจสอบ', '', ''),
(47, '2240308182504', 2, 15, 1, 5590, '2024-03-08 11:25:04', 'รอตรวจสอบ', '', ''),
(48, '2240310205854', 2, 15, 1, 5590, '2024-03-10 13:58:54', 'รอตรวจสอบ', '', ''),
(49, '2240310212026', 2, 13, 1, 2399, '2024-03-10 14:20:26', 'รอตรวจสอบ', '', '');
...
(2, 'NIKE Air Rival Fly 3', 04, 05, 'พร้อมซัพพอร์ตในทุกเส้นทาง รองเท้าวิ่ง NIKE Zoom Winflo 8 มาพร้อมโครงสร้างเบาสบายและพื้นรองเท้าที่สปริงเพื่อส่งคืนพลังในทุกการลงน้ำหนักเท้า', '210150627520240120_164253.png', '39', 3740, '23', 'ชาย', 7, '2021-06-26 16:46:13'),
(3, 'Fila Disruptor 2', 01, 06, 'มีลักษณะเนื้อฉ่ำแน่น รสชาติเข้มข้น มีสัดส่วนของช็อกโกแลตสูงและสัดส่วนของแป้งจะน้อยกว่าแบบอื่น หน้ามีความกรอบ หรืออาจเรียกได้ว่า บราวนี่หน้ากรอบ', '204226960720240120_164037.jpg', '39', 2790, '27', 'หญิง', 5, '2021-06-26 16:46:35'),
(4, 'LACOSTE Graduate Tri 1', 01, 02, 'รองเท้าสนีกเกอร์ลาคอสท์ รุ่น Graduate วัสดุสังเคราะห์ สำหรับคุณผู้ชาย \r\n\r\nใช้งานได้จริงอย่างมีสไตล์ไปกับรองเท้าสนีกเกอร์ลาคอสท์ รุ่น Graduate แรงบันดาลใจจากสไตล์สปอร์ตให้ผลลัพธ์เป็นรองเท้าที่โดดเด่นในซัมเมอร์นี้ ด้านบนของรองเท้าผลิตขึ้นจากหนังสีขาวล้วนเนื้อนิ่ม โดยส่วนส้นรองเท้ามีสีน้ำเงินเข้มและพื้นที่บุรองด้านในก็เช่นกัน ตัวอักษร Lacoste สีทองเพิ่มความหรูหรา และรวมถึงตราจระเข้ลาคอสท์สามสีที่ปักอยู่ด้านข้างของรองเท้า', '200506179620240120_163923.jpg', '36', 3490, '19', 'ชาย', 6, '2021-06-26 16:46:51'),
...
(55, 2, 2, '<p>ธรรมดา</p>', '320240305_005520.jpg', '2024-03-04 17:55:20');
...
--
ALTER TABLE `tbl_brand`
  MODIFY `brand_id` int(2) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT 'รหัสแบรนด์', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_cart`
--
ALTER TABLE `tbl_cart`
  MODIFY `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัสตะกร้า', AUTO_INCREMENT=367;

--
-- AUTO_INCREMENT for table `tbl_checkcoupon`
--
ALTER TABLE `tbl_checkcoupon`
  MODIFY `id_checkcoupon` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID เช็คคูปอง', AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT for table `tbl_coupon`
--
ALTER TABLE `tbl_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'IDคูปอง', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_member`
--
ALTER TABLE `tbl_member`
  MODIFY `member_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัสผู้ใช้', AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `tbl_order`
--
ALTER TABLE `tbl_order`
  MODIFY `o_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID order', AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `tbl_product`
--
ALTER TABLE `tbl_product`
  MODIFY `p_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'รหัสสินค้า', AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_reviews`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID รีวิว', AUTO_INCREMENT=57;
