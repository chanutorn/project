...
<form action="m_add_db.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" name="m_tel" required class="form-control" maxlength="10" pattern="^[0-9]+$" title="ตัวเลขเท่านั้น">
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-2 control-label">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-3">
      <textarea type="text" name="m_address" required class="form-control"></textarea>
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-2">
